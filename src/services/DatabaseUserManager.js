  ...
  async createCollege(collegeData) {
    try {
      ...
      const fieldMap = {
        ...
        tutorContactName: 'tutorname',
        tutorContactPosition: 'tutorposition',
        tutorContactEmail: 'tutoremail',
        careersContactName: 'careerscontactname',
        careersContactPosition: 'careerscontactposition',
        careersContactEmail: 'careerscontactemail',
    ...
    try {
      ...
      return colleges.map(college => {
        ...
        return {
          ...
          tutorContactName: collegeData.tutorname || '',
          tutorContactPosition: collegeData.tutorposition || '',
          tutorContactEmail: collegeData.tutoremail || '',
          careersContactName: collegeData.careerscontactname || '',
          careersContactPosition: collegeData.careerscontactposition || '',
          careersContactEmail: collegeData.careerscontactemail || '',
