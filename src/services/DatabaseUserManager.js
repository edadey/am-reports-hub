  ...
  async createCollege(collegeData) {
    try {
      ...
      const fieldMap = {
        ...
        careersContactName: 'careersname',
        careersContactEmail: 'careersemail',
        careersContactPosition: 'careersposition',
    ...
    try {
      ...
      return colleges.map(college => {
        ...
        return {
          ...
          careersContactName: collegeData.careersname || '',
          careersContactPosition: collegeData.careersposition || '',
          careersContactEmail: collegeData.careersemail || '',
