module.exports = (sequelize, DataTypes) => {
  const College = sequelize.define('College', {
    ...
    careerscontactname: {
      type: DataTypes.STRING,
      allowNull: true,
      field: 'careerscontactname',
    },
    careerscontactposition: {
      type: DataTypes.STRING,
      allowNull: true,
      field: 'careerscontactposition',
    },
    careerscontactemail: {
      type: DataTypes.STRING,
      allowNull: true,
      field: 'careerscontactemail',
    },
